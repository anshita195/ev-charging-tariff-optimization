...
├── requirements.txt
├── README.md
└── outputs/                         # Generated by notebook, exported to Drive
    ├── output_metrics_summary.csv
    ├── output_monitoring_daily.csv
    ├── output_pricing_zones.csv
    ├── output_test_predictions.csv   # 50K-row sample
    └── output_acn_clean.csv
```
